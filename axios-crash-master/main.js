...
function getTodos() {
  ...
  //using .get is not needed
  axios.get('https://jsonplaceholder.typicode.com/todos?_limit=5', { timeout: 5000 }).then(res => showOutput(res)).catch(err => console.log(err))
}
...
function updateTodo() {
  ...
  axios.patch('https://jsonplaceholder.typicode.com/todos/1', {
    title: 'Updated todo',
    completed: true
  }).then(res => showOutput(res)).then(err => console.log(err))
}
